...
import { CONFIG, getAge, getAssetUrl } from '../config';
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4 leading-relaxed max-w-xl">
              I am a <strong className="text-slate-900 dark:text-white font-semibold">{age}-year-old {CONFIG.yearLabel} Industrial Engineering</strong> student at KU Leuven, passionate about bridging the gap between hardware and software.
            </p>

...
const Skills: React.FC = () => {
  ...
  return (
    <section id="skills" className={`py-16 bg-slate-50 dark:bg-slate-950 transition-colors duration-300 circuit-bg ${isVisible ? 'animate-fade-in' : ''}`} ref={elementRef as any}>
